...
//        GT_Values.RA.addAlloySmelterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Rubber, 2), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Copper, 1), GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Copper, 1), 100, 16);
	...
	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Redstone, 5L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Ruby, 4L), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, ItemList.IC2_Energium_Dust.get(1L, new Object[0]), 100, 8);
        ...
        GT_ModHandler.addPulverisationRecipe(ItemList.IC2_EnergyCrystal.getWithDamage(1L, new Object[0]), ItemList.IC2_Energium_Dust.get(9L, new Object[0]), GT_Values.NI, false);
        GT_Values.RA.addCentrifugeRecipe(ItemList.IC2_Energium_Dust.get(9L, new Object[0]), null, null, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ruby, 4L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 5L), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{10000,10000}, 620, 48);
...
//Circuit Recipes!!!
	...
	GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Silicone, 8), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Tantalum, 2),Materials.Plastic.getMolten(72), ItemList.Circuit_Parts_CapacitorSMD.get(64, o), 120, 120);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.foil, Materials.PolyvinylChloride, 8), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Tantalum, 2),Materials.Plastic.getMolten(72), ItemList.Circuit_Parts_CapacitorSMD.get(64, o), 100, 120);
...
//            GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RockSalt, 1L), tFluid, FluidRegistry.getFluid("potion.saltywater"), true);
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcite, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.TricalciumPhosphate, 1L), new FluidStack(tFluid, 1000), GT_Values.NF, ItemList.IC2_Fertilizer.get(3L, new Object[0]), 300);
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcium, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.TricalciumPhosphate, 1L), new FluidStack(tFluid, 1000), GT_Values.NF, ItemList.IC2_Fertilizer.get(4L, new Object[0]), 400);
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Apatite, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.TricalciumPhosphate, 1L), new FluidStack(tFluid, 1000), GT_Values.NF, ItemList.IC2_Fertilizer.get(4L, new Object[0]), 400);
            ...
            GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glauconite, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.TricalciumPhosphate, 1L), new FluidStack(tFluid, 1000), GT_Values.NF, ItemList.IC2_Fertilizer.get(4L, new Object[0]), 400);
            ...
            if (Materials.GlauconiteSand.mHasParentMod) {
                ...
                GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.GlauconiteSand, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.TricalciumPhosphate, 1L), new FluidStack(tFluid, 1000), GT_Values.NF, ItemList.IC2_Fertilizer.get(4L, new Object[0]), 400);
	...
	if (GT_Mod.gregtechproxy.mEasyEnderIOMaterialsRecipe) {
	...
	GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Ilmenite, 1L), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Carbon, 1L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.WroughtIron, 1L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Rutile, 1L), 200, 500, 1700);    
...
//        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Gunpowder, 4L), new ItemStack(Blocks.sand, 4, 32767), new ItemStack(Blocks.tnt, 1), 400, 1);
	...
	for (OrePrefixes tPrefix : Arrays.asList(new OrePrefixes[]{OrePrefixes.dust, OrePrefixes.dustSmall, OrePrefixes.dustTiny})) {
 	...
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Indium, 1L), GT_OreDictUnificator.get(tPrefix, Materials.Gallium, 1L), GT_OreDictUnificator.get(tPrefix, Materials.Phosphorus, 1L), null, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.IndiumGalliumPhosphide, 3L * tPrefix.mMaterialAmount), (int) (200L * tPrefix.mMaterialAmount / 3628800L), 8);
 	...
 	//Spartak Ender IO Dust Mixer
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.Copper, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Redstone, 4L), GT_Utility.getIntegratedCircuit(2), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.RedAlloy, 1L * tPrefix.mMaterialAmount), (int) (100L * tPrefix.mMaterialAmount / 3628800L), 8);
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.Redstone, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Silicon, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Coal, 1L), GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.RedstoneAlloy, 3L * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.RedstoneAlloy, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Iron, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Silver, 1L), GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.ConductiveIron, 3L * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.ConductiveIron, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Gold, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.BlackSteel, 1L), GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.EnergeticAlloy, 3L * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.EnergeticAlloy, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.EnderEye, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Chrome, 1L), GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.VibrantAlloy, 3L * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.Steel, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Coal, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Silicon, 1L), GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.ElectricalSteel, 3L * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.Iron, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.EnderPearl, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.RedstoneAlloy, 1L), GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.PulsatingIron, 3L * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
 	GT_Values.RA.addMixerRecipe(new ItemStack(Blocks.soul_sand, 1, 0), GT_OreDictUnificator.get(tPrefix.dust, Materials.Gold, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Ash, 1L), GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.Soularium, 3L * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.ElectricalSteel, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Coal, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Obsidian, 1L), GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.DarkSteel, 3L * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.DarkSteel, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Endstone, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Tungsten, 1L), GT_Values.NI, GT_Values.NI, GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(tPrefix.dust, Materials.EndSteel, 3L), 100, 8);
 	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix.dust, Materials.Tin, 2L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Silver, 1L), GT_OreDictUnificator.get(tPrefix.dust, Materials.Platinum, 1L), GT_Values.NI, GT_Values.NI, GT_Utility.getIntegratedCircuit(3), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(tPrefix.dust, Materials.EnderiumBase, 4L), 400, 8);
	}
	...
	GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quicklime, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone, 3L), GT_Values.NI, GT_Values.NI, Materials.Water.getFluid(500L), Materials.Concrete.getMolten(576L), GT_Values.NI, 20, 16);
        ...
        GT_Values.RA.addCentrifugeRecipe(new ItemStack(Blocks.melon_block, 16, 0), GT_Values.NI, GT_Values.NF, Materials.Methane.getGas(576L), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, null, 4608, 5);
...
//        Quantumsuite
	...
	private void addChemicalRecipesComplicated(){
    	...
    	GT_Values.RA.addMultiblockChemicalRecipe(null, new FluidStack[]{Materials.Chlorine.getGas(5000), Materials.Water.getFluid(15000), Materials.Mercury.getFluid(1000)}, new FluidStack[]{Materials.HypochlorousAcid.getFluid(15000)}, null, 600, 8);
        ...
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Phosphorus.getDust(2), GT_Values.NI, Materials.Oxygen.getGas(5000), GT_Values.NF, Materials.PhosphorousPentoxide.getDust(7), GT_Values.NI, 80, 30);
    	GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{Materials.Phosphorus.getDust(2), GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.Oxygen.getGas(5000)}, null, new ItemStack[]{Materials.PhosphorousPentoxide.getDust(7)}, 80, 30);
    	...
    	GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{Materials.Phosphorus.getDust(1), GT_Utility.getIntegratedCircuit(24)}, new FluidStack[]{Materials.Oxygen.getGas(2500), Materials.Water.getFluid(4500)}, new FluidStack[]{Materials.PhosphoricAcid.getFluid(8000)}, null, 320, 30);
        ...
        GT_Values.RA.addChemicalRecipe(Materials.Cumene.getCells(11), GT_Utility.getIntegratedCircuit(1),Materials.Oxygen.getGas(1000),Materials.Acetone.getFluid(6000),Materials.Phenol.getCells(6),Materials.Empty.getCells(5), 160);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Oxygen.getCells(1),Materials.Empty.getCells(5),Materials.Cumene.getFluid(11000),Materials.Acetone.getFluid(6000),Materials.Phenol.getCells(6), GT_Values.NI, 160, 30);
        GT_Values.RA.addChemicalRecipe(Materials.Cumene.getCells(11), GT_Utility.getIntegratedCircuit(11), Materials.Oxygen.getGas(1000),Materials.Phenol.getFluid(6000),Materials.Acetone.getCells(6), Materials.Empty.getCells(5), 160);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(Materials.Oxygen.getCells(1),Materials.Empty.getCells(5),Materials.Cumene.getFluid(11000),Materials.Phenol.getFluid(6000),Materials.Acetone.getCells(6),GT_Values.NI,160, 30);
	...
	GT_Values.RA.addMixerRecipe(new ItemStack(Blocks.sand, 1), Materials.Coal.getDustSmall(1), Materials.Saltpeter.getDust(1), GT_Values.NI, Materials.Oil.getFluid(160), GT_Values.NF, new ItemStack(Blocks.soul_sand), 100, 16);
